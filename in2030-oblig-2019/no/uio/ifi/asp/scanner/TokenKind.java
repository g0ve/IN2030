...
public enum TokenKind {
    ...
    /**
    * After having to write every check for each operator/keyword. (Like we did in the week assignments)
    * We realised there had to be a better way.
    *
    * Beacuase neither of us have worked with enum before. We looked at the javadoc.
    * After reading that we found out about the static method values().
    * We therefor made a protected list values that we could use in scanner.
    * With this list we could easily make a check method to check if a keyword/operator exists in Scanner.
    */
